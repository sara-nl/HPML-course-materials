...
class MNISTClassifier(L.LightningModule):
    ...
    def train_dataloader(self):
        return DataLoader(
            self.mnist_train, batch_size=self.batch_size, shuffle="True", num_workers=3
        )
    ...
    def test_dataloader(self):
        return DataLoader(
            self.mnist_test, batch_size=self.test_batch_size, num_workers=3
        )
...
def main():
    ...
    model = MNISTClassifier(
        args.lr, args.gamma, MNIST_DATA, args.batch_size, args.test_batch_size
    )
